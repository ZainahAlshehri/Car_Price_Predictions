...
# Overview:
The goal of this project is that we are going to build a linear regression model that predicts the prices of the cars based on the features. also to test and validate features which effect the price of the car, based on validating different kind of experiments to finalize the best R square score result. using the data from the Kaggle website . We will do a comprehensive analysis with all data cleaning, exploration, visualization, feature selection, model building, and evaluation. 
